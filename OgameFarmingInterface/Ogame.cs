...
/*            13 EM */{        100,            1, 1000000 }
    ...
    public class RapportDEspionnage
    {
        ...
        private UInt32 RapportDEspionnageCasting(JToken value, ref Boolean m_BatimentsEstValide)
        {

            if ((int)value > 0)
            {
                m_BatimentsEstValide = true;
            }
            try
            {
                return (UInt32)value;
        ...
        public RapportDEspionnage(JObject rapportJobject)
        {
            init();
            ...
            try
            {
                NomDeLaPlanete = (string)rapportJobject["planet_name"];
                Coordonnees = (string)rapportJobject["coordinates"];
                FlotteAQuai.CoordonneesDeDepart = Coordonnees;

                System.DateTime dtDateTime = new DateTime(1970, 1, 1, 0, 0, 0, 0, System.DateTimeKind.Utc);
                DateEtHeure = dtDateTime.AddSeconds((int)rapportJobject["dateRE"]).ToLocalTime();


                Ressources.Metal = (UInt32)rapportJobject["metal"];
                Ressources.Cristal = (UInt32)rapportJobject["cristal"];
                Ressources.Deuterium = (UInt32)rapportJobject["deuterium"];
                Ressources.Energie = (UInt32)rapportJobject["energie"];

                // il faut  determiner si lune ou planete
                //todo lune ou planete
                //todo def valide
                //todo bat valide
                //todo flotte valide
                //todo recherche
                ...
                //flotte
                 FlotteAQuai.Bombardiers = RapportDEspionnageCasting(rapportJobject["BMD"], ref _FlotteAQuaiEstValide);
                 FlotteAQuai.ChasseursLegers = RapportDEspionnageCasting(rapportJobject["CLE"], ref _FlotteAQuaiEstValide);
                FlotteAQuai.ChasseursLourds = RapportDEspionnageCasting(rapportJobject["CLO"], ref _FlotteAQuaiEstValide);
                FlotteAQuai.Croiseurs = RapportDEspionnageCasting(rapportJobject["CR"], ref _FlotteAQuaiEstValide);
                FlotteAQuai.Destructeurs = RapportDEspionnageCasting(rapportJobject["DST"], ref _FlotteAQuaiEstValide);
                 FlotteAQuai.Battlecruiser = RapportDEspionnageCasting(rapportJobject["TRA"], ref _FlotteAQuaiEstValide);
                FlotteAQuai.EtoilesDeLaMort = RapportDEspionnageCasting(rapportJobject["EDLM"], ref _FlotteAQuaiEstValide);
                 FlotteAQuai.GrandTransporteurs = RapportDEspionnageCasting(rapportJobject["GT"], ref _FlotteAQuaiEstValide);
                FlotteAQuai.PetitsTransporteurs = RapportDEspionnageCasting(rapportJobject["PT"], ref _FlotteAQuaiEstValide);
                 FlotteAQuai.Recycleurs = RapportDEspionnageCasting(rapportJobject["REC"], ref _FlotteAQuaiEstValide);
                 FlotteAQuai.SatellitesSolaires = RapportDEspionnageCasting(rapportJobject["SAT"], ref _FlotteAQuaiEstValide);
                FlotteAQuai.SondesDEspionnage = RapportDEspionnageCasting(rapportJobject["SE"], ref _FlotteAQuaiEstValide);
                FlotteAQuai.VaisseauxDeBataille = RapportDEspionnageCasting(rapportJobject["VB"], ref _FlotteAQuaiEstValide);
                 FlotteAQuai.VaisseauxDeColonisation = RapportDEspionnageCasting(rapportJobject["VC"], ref _FlotteAQuaiEstValide);
            

                //defense
                Defenses.ArtilleriesAIons = RapportDEspionnageCasting(rapportJobject["AI"], ref _DefensesEstValide);
                Defenses.ArtilleriesLaserLegeres = RapportDEspionnageCasting(rapportJobject["LLE"], ref _DefensesEstValide);
                Defenses.ArtilleriesLaserLourdes = RapportDEspionnageCasting(rapportJobject["LLE"], ref _DefensesEstValide);
                Defenses.CanonsDeGauss = RapportDEspionnageCasting(rapportJobject["CG"], ref _DefensesEstValide);
                Defenses.GrandBouclier = RapportDEspionnageCasting(rapportJobject["GB"], ref _DefensesEstValide);
                Defenses.LanceursDeMissiles = RapportDEspionnageCasting(rapportJobject["LM"], ref _DefensesEstValide);
                Defenses.LanceursDePlasma = RapportDEspionnageCasting(rapportJobject["LP"], ref _DefensesEstValide);
                Defenses.MissilesDInterception = RapportDEspionnageCasting(rapportJobject["MIC"], ref _DefensesEstValide);
                Defenses.MissilesInterplanetaires = RapportDEspionnageCasting(rapportJobject["MIP"], ref _DefensesEstValide);
                Defenses.PetitBouclier = RapportDEspionnageCasting(rapportJobject["PB"], ref _DefensesEstValide);

                //batiments
                Batiments.BaseLunaire = RapportDEspionnageCasting(rapportJobject["BaLu"], ref _BatimentsEstValide);
                Batiments.CentraleFusion = RapportDEspionnageCasting(rapportJobject["CEF"], ref _BatimentsEstValide);
                Batiments.CentraleSolaire = RapportDEspionnageCasting(rapportJobject["CES"], ref _BatimentsEstValide);
                Batiments.ChantierSpatial = RapportDEspionnageCasting(rapportJobject["CSp"], ref _BatimentsEstValide);
                Batiments.HangarDeCristal = RapportDEspionnageCasting(rapportJobject["HC"], ref _BatimentsEstValide);
                Batiments.HangarDeMetal = RapportDEspionnageCasting(rapportJobject["HM"], ref _BatimentsEstValide);
                Batiments.LaboratoireDeRecherche = RapportDEspionnageCasting(rapportJobject["Lab"], ref _BatimentsEstValide);
                Batiments.MineDeCristal = RapportDEspionnageCasting(rapportJobject["C"], ref _BatimentsEstValide);
                Batiments.MineDeMetal = RapportDEspionnageCasting(rapportJobject["M"], ref _BatimentsEstValide);
                Batiments.PhalangeDeCapteur = RapportDEspionnageCasting(rapportJobject["Pha"], ref _BatimentsEstValide);
                Batiments.PorteDeSautSpatial = RapportDEspionnageCasting(rapportJobject["PoSa"], ref _BatimentsEstValide);
                Batiments.ReservoirDeDeuterium = RapportDEspionnageCasting(rapportJobject["HD"], ref _BatimentsEstValide);
                Batiments.SiloDeMissiles = RapportDEspionnageCasting(rapportJobject["Silo"], ref _BatimentsEstValide);
                Batiments.SynthetiseurDeDeuterium = RapportDEspionnageCasting(rapportJobject["D"], ref _BatimentsEstValide);
                Batiments.Terraformeur = RapportDEspionnageCasting(rapportJobject["Ter"], ref _BatimentsEstValide);
                Batiments.UsineDeNanites = RapportDEspionnageCasting(rapportJobject["UdN"], ref _BatimentsEstValide);
                Batiments.UsineDeRobots = RapportDEspionnageCasting(rapportJobject["UdR"], ref _BatimentsEstValide);

                //technologie
                Recherches.Armes = RapportDEspionnageCasting(rapportJobject["Armes"], ref _RecherchesEstValide);
                Recherches.Bouclier =  RapportDEspionnageCasting(rapportJobject["Bouclier"], ref _RecherchesEstValide);
                 Recherches.Energie =  RapportDEspionnageCasting(rapportJobject["NRJ"], ref _RecherchesEstValide);
                  Recherches.Espionnage = RapportDEspionnageCasting(rapportJobject["Esp"], ref _RecherchesEstValide);
                 Recherches.Graviton = RapportDEspionnageCasting(rapportJobject["Graviton"], ref _RecherchesEstValide);
                    Recherches.Hyperespace =  RapportDEspionnageCasting(rapportJobject["Hyp"], ref _RecherchesEstValide);
                  Recherches.Ions = RapportDEspionnageCasting(rapportJobject["Ions"], ref _RecherchesEstValide);
                Recherches.Laser = RapportDEspionnageCasting(rapportJobject["Laser"], ref _RecherchesEstValide);
                Recherches.Ordinateur =  RapportDEspionnageCasting(rapportJobject["Ordi"], ref _RecherchesEstValide);
                 Recherches.Plasma =  RapportDEspionnageCasting(rapportJobject["Plasma"], ref _RecherchesEstValide);
                Recherches.PropulsionHyperespace =  RapportDEspionnageCasting(rapportJobject["PH"], ref _RecherchesEstValide);
                 Recherches.ProtectionDesVaisseauxSpatiaux =  RapportDEspionnageCasting(rapportJobject["Protection"], ref _RecherchesEstValide);
                 Recherches.ReacteurACombustion =  RapportDEspionnageCasting(rapportJobject["RC"], ref _RecherchesEstValide);
                 Recherches.ReacteurAImpulsion = RapportDEspionnageCasting(rapportJobject["RI"], ref _RecherchesEstValide);
                 Recherches.ReseauDeRechercheIntergalactique =  RapportDEspionnageCasting(rapportJobject["RRI"], ref _RecherchesEstValide);

                // par defaut coordonnées sont pour planetes

                EstUneLune = false;
                if(Batiments.BaseLunaire > 0)
                {
                    EstUneLune = true;
...
/*               GB */{         0,    10000,   100000,       0 }
    ...
    public class InterfaceServeur
    {
        ...
        public bool Connecte()
        {
            ...
            try
            {
                string value = string.Format("login={0}&password={1}", Login, MotDePasse);
                string content = Get_Ogspy_Content(URL, value);


                JObject obj = JObject.Parse(content);
                //MessageBox.Show(obj["status"].ToString());
                //MessageBox.Show(obj["api_token"].ToString());

                if (obj["status"] == null || obj["status"].ToString() != "ok")
                {
                    AuthString = "";
                    return false;
                }
                ...
                {
                    AuthString = obj["status"].ToString();
                    Token = obj["api_token"].ToString();
        ...
        /// <summary>
        /// Retourne les information du serveur
        /// </summary>
        /// <returns></returns>
        public string ogspy_server_details()
        {
            Dictionary<string, string> dictionary = new Dictionary<string, string>();
            dictionary.Add("cmd", "ogspy_server_details");
            var json = JsonConvert.SerializeObject(dictionary);
            string arg = "data=" + json.ToString();
            JObject jobj = JObject.Parse(Get_Ogspy_Content(URL, arg));
            //formatage retour
            string retour = "";
            foreach (JProperty x in (JToken)jobj["content"])
            {
                string name = x.Name;
                JToken value = x.Value;
                retour += x.Name + " = " + x.Value + Environment.NewLine;
            }

            return retour;
        }

        public string Get_Ogspy_Content(string url, string args = "")
        {
            url = String.Format("{0}/mod/api/api.php", url);
            Uri uri = new Uri(url);
            ...
            request.UserAgent = "OFI v" + OgameFarmingInterface.FormPrincipale.version_courante.ToString();
            ...
            args = args + "&sender=ofi&v=" + OgameFarmingInterface.FormPrincipale.version_courante;
        ...
        //ogspy_server_details
        public bool Connecte_Old()
        {
            if (EstConnecte)
            {
                Deconnecte();
        ...
        public Collection<RapportDEspionnage> ImporterLesRapportsDepuis(DateTime date)
        {
            ...
            Dictionary<string, string> dictionary = new Dictionary<string, string>();
            dictionary.Add("cmd", "api_send_ogspy_spy");
            dictionary.Add("since", date.ToString("yyyy-MM-dd") + " 01:01:01");
            var json = JsonConvert.SerializeObject(dictionary);
            string arg = "data=" + json.ToString();
            ...
            int NBRE = items.Count;

            // on parcour chaque re pour l'inserer à la collection
            for (int indexRE = 0; indexRE < NBRE; indexRE++)
            {
                try
                {
                    JObject rapportJson = (JObject)jobj["content"][indexRE];
                    RapportDEspionnage rapport = new RapportDEspionnage(rapportJson);
                    retour.Add(rapport);
                ...
                catch (Exception ex)
                {
                    ...
                    log.Debug(ex.Source);
                    log.Debug("Source :");
                    log.Debug(jobj["content"][indexRE].ToString());
                }
        ...
        public Collection<RapportDEspionnage> ImporterLesRapportsDepuis_old(DateTime date)
        {
            if (!EstConnecte)
            {
                throw new Exception("Impossible d'importer une galaxie : non connecté au serveur.");
